...
const reducer = (state,action) =>{
    switch(action.type){
        case 'JUMP':
            return{...state,xIsNext:action.payload.step%2===0,history:state.history.slice(0,action.payload+1),}
        case 'MOVE':
...
const calculateWinner = (squares)=>{
    const winnerLines = [[0,1,2],[3,4,5],[0,3,6],[6,7,8],[1,4,7],[2,5,8],[0,4,8],[2,4,6]];
    let isDraw = true;
