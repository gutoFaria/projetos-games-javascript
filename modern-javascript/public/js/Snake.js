 export default class Snake{
    ...
    positionApple(){
        ...
        this.apple.y =Math.floor( Math.random() * this.scene.game.config.heith / this.tileSize )* this.tileSize;
    }
     ...
     move(){
        ...
        if(this.body[0].x < 0 || this.body[0].x >= this.scene.game.config.width || this.body[0].y >= this.scene.game.config.height)
        {
